...
{   
    ...
    //This method will return view edit roles page
    ...
    //This method will update a roles
    public function update($id, Request $request)
    {
        ...
        if ($validator->passes()){
           ...
           $role->save();
            ...
            return redirect()->route('roles.list')->with('success', 'role update successfully');
        }else {
    ...
    //This method will delete roles page
