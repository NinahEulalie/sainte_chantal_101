    ...
    <div class="container py-5 h-100">
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
          <div class="card bg-dark text-white" style="border-radius: 1rem;background: linear-gradient(to right, rgb(110, 53, 53), rgb(41, 8, 8));">
            <div class="card-body p-5 text-center">
              ...
              <div>
                <p class="mb-0">Don't have an account? <a href="{{route('show.register')}}" class="text-white-50 fw-bold">Sign Up</a>
                </p>
              </div>
